-- User table 
INSERT INTO users(id, firstName, lastName, userName, email, password, createdAt, updateAt)
...
-- bandUser Table
INSERT INTO bandUsers(id, bandName, bandBio, userName, email, genre, contact, youtube, facebook, insta, twitter, password, FOREIGNKEY, createdAt, updateAt)
