...
export default function BandHome() {
    ...
    function handleFavorite(res) {
        console.log(authState)
        const obj = {res, authState}
    ...
    return (
        <div>
            ...
            <BandJumbotron band={bandState} />
            <Container fluid>
                <Row>
                    <Col lg={3} style={{marginTop:"10px", marginBottom:"10px"}}>
                        <BandBioCard band={bandState} />
                        <FavBtn handleFavorite={handleFavorite} band={bandState} />
                    </Col>
                    <Col lg={5} style={{marginTop:"10px", marginBottom:"10px"}}>
                        <EventsGroup band={bandState} />
                    </Col>
                    <Col lg={4} style={{marginTop:"10px", marginBottom:"10px"}}>
                        <ContactCard band={bandState} />
                    </Col>
                </Row>
            </Container>
